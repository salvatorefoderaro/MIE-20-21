...
<html lang="en">
            ...
            (function($) {
                $(document).ready( function() {
                    $('#color').change(function() {
                        ...
                        document.location.href = "uniAdu.jsp?univName="+strUser;
                    });
                });
            })(jQuery);
        </script>
    ...
    <%
        ...
        if(request.getParameter("univName") != null){
            session.setAttribute("selectedUni", request.getParameter("univName"));
            session.setAttribute("profAssolutaList", "null");
        }  %>
        <div id="wrapper">
            ...
            <div id="page-wrapper">    
                ...
                <p><select class="form-control" name="color" id="color" onchange="">
                    <option value="" disabled selected>Seleziona uiversità...</option>
                    <option value="UNIV_Demo (2009-2013)"> UNIV_Demo (2009-2013) </option>
                    <option value="Università Politecnica delle Marche (2009-2013)"> Università Politecnica delle Marche (2009-2013)</option>
                    <option value="UNIV_Demo (2009-2013)"> Green</option>
                    <option value="UNIV_Demo (2009-2013)"> Pink</option>
                </select></p>
                                    ...
                                    <div class="panel-body">
                                        <div class="dataTable_wrapper">
                                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${profAssolutaList}" var="p">
                                                        <tr class="odd gradeX">
